...
/******/ 	// eslint-disable-next-line no-unused-vars
/******/ 	var hotCurrentHash = "000474fa509fda510e54";
...
/******/ 	return hotCreateRequire("./src/example.js")(__webpack_require__.s = "./src/example.js");
/******/ })
/************************************************************************/
/******/ ({

/***/ "./node_modules/css-loader/index.js!./src/example.css":
/*!***************************************************!*\
  !*** ./node_modules/css-loader!./src/example.css ***!
  \***************************************************/
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return DateTranslator; });
...
/* harmony import */ var debounce__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! debounce */ "debounce");
...
function translate(value, model, onTranslate = noop) {
  if (value && value.length >= _utils__WEBPACK_IMPORTED_MODULE_3__["lenMachineVocab"]) {

    const source = str2int(value, tx)
    const onehotSource = _tensorflow_tfjs__WEBPACK_IMPORTED_MODULE_1__["oneHot"](_tensorflow_tfjs__WEBPACK_IMPORTED_MODULE_1__["tensor1d"](source, 'int32'), _utils__WEBPACK_IMPORTED_MODULE_3__["numClasses"])
    const reshapedSource = onehotSource.reshape([m].concat(onehotSource.shape))

    const prediction = model.predict([reshapedSource, _utils__WEBPACK_IMPORTED_MODULE_3__["s0"], _utils__WEBPACK_IMPORTED_MODULE_3__["c0"]])

    const date = prediction.reduce((acc, pred) => {
      const pIdx = pred
        .reshape([_utils__WEBPACK_IMPORTED_MODULE_3__["lenMachineVocab"]])
        .argMax()
        .get()

      return acc + _utils__WEBPACK_IMPORTED_MODULE_3__["invMachineVocab"][pIdx]
    }, '')
...
async function DateTranslator(config) {
  ...
  if (input) {
    ...
    const model = await _tensorflow_tfjs__WEBPACK_IMPORTED_MODULE_1__["loadModel"]('./tfjsmodel/model.json')
...
var content = __webpack_require__(/*! !../node_modules/css-loader!./example.css */ "./node_modules/css-loader/index.js!./src/example.css");
...
if(true) {
	module.hot.accept(/*! !../node_modules/css-loader!./example.css */ "./node_modules/css-loader/index.js!./src/example.css", function() {
		var newContent = __webpack_require__(/*! !../node_modules/css-loader!./example.css */ "./node_modules/css-loader/index.js!./src/example.css");
...
/*!**********************!*\
  !*** ./src/utils.js ***!
  \**********************/
/*! exports provided: s0, c0, humanVocab, machineVocab, invMachineVocab, numClasses, lenMachineVocab, str2int, noop */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
const s0 = Object(_tensorflow_tfjs__WEBPACK_IMPORTED_MODULE_0__["zeros"])([m, ns], 'int32')
const c0 = Object(_tensorflow_tfjs__WEBPACK_IMPORTED_MODULE_0__["zeros"])([m, ns], 'int32')
...
function str2int(str, length, vocab) {
  str = str
    .toLowerCase()
    .replace(',','')
